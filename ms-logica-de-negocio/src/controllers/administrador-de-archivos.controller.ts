...
export class AdministradorDeArchivosController {
  ...
  async CargarArchivoProducto(
    ...
    const filePath = path.join(__dirname, ConfiguracionGeneral.carpetaArchivosVehiculos);
  ...
  private ObtenerArchivosPorTipo(tipo: number) {
    ...
    switch (tipo) {
      // amusement
      case 1:
        filePath = path.join(__dirname, ConfiguracionGeneral.carpetaArchivosVehiculos);
        break;
      case 2:
        break;
    }
